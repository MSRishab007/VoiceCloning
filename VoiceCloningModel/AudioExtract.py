...
def split_audio_whisper(audio_path, audio_name, target_dir='processed'):
    ...
    for k, w in enumerate(segments):
        ...
        save = audio_seg.duration_seconds > 1.5 and audio_seg.duration_seconds < 20. and len(text) >= 2 and len(text) < 200
        if save:
...
def get_se(audio_path, vc_model, target_dir='processed', vad=True):
    ...
    return vc_model.extract_speaker_embeddings(audio_segs, se_save_path=se_path), audio_name
